...
export default function AppIcon({
  ...
  if (IoniconsName) {
    return <Ionicons {...props} name={IoniconsName} />;
  }
  if (AntDesignName) {
    return <AntDesign {...props} name={AntDesignName} />;
  }
  if (EntypoName) {
    return <Entypo {...props} name={EntypoName} />;
  }
  if (EvilIconsName) {
    return <EvilIcons {...props} name={EvilIconsName} />;
  }
  if (FeatherName) {
    return <Feather {...props} name={FeatherName} />;
  }
  if (FontAwesomeName) {
    return <FontAwesome {...props} name={FontAwesomeName} />;
  }
  if (FontAwesome5Name) {
  ...
  if (FontistoName) {
    return <Fontisto {...props} name={FontistoName} />;
  }
  if (FoundationName) {
    return <Foundation {...props} name={FoundationName} />;
  }
